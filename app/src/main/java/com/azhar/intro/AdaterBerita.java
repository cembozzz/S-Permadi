...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // Layout inflater
        View view = LayoutInflater.from(context).inflate(R.layout.activity_kuliner_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.100.8/Portal/images/" + berita.get(position).getFoto();
